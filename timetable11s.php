...
<?php
	...
	<form action="saveTime11s.php" method="post" enctype="multipart/form-data">
	<?php 

		$sql =	mysql_query("select * from c11s_timetbl where sl=1");
	...
	*English,Physics,Chemistry,Mathematics,Biology,Mils,Environmental Education,Computer Science, Informatics Practices, Information Technology, Travel & Tourism<BR>
	*EXAM dates should be entered in ascending order</p>
	</div></div>
	<div class="panel-body">
	<div style="font-size: 30px;font-weight: bold;font-style: italic;color: blue">CLASS-XI(Science)</div>
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=2");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=3");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=4");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=5");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=6");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=7");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=8");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=9");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=10");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=11");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=12");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11s_timetbl where sl=13");
		$row = mysql_fetch_array($sql);
