...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "centreChange12c.php", // "another_php_file.php",
                        data: 'theOption=' + sel,
...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "another_php_file12c.php", // "another_php_file.php",
                        data: {
                            'dist' : sel,
                            'scho' : sel1,
...
require("dbconn.php");
$query = mysql_query("select distinct district from c12c_pkChrt ");

?>
<form action="updatePckChrt12c.php" method="POST" enctype="multipart/form-data">
<div class="container">
