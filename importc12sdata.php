...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "clearData12s.php", // "another_php_file.php",
                        data: 'theOption=' + sel,
...
<input type="button" class="btn btn-primary" name="val" value="Clear Data" id="cls" onfocus="clearData()">       </div>
        <div class="panel-body">
            <form action="importData12s.php" method="post" enctype="multipart/form-data" id="importFrm">
            ...
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    $query =mysql_query("SELECT * FROM c12s_pkChrt");
