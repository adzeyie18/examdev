...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "clearData11c.php", // "another_php_file.php",
                        data: 'theOption=' + sel,
...
<div >
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <form action="importData11c.php" method="post" enctype="multipart/form-data" id="importFrm">
            ...
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    $query =mysql_query("SELECT * FROM c11c_pkChrt");
