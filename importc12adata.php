...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "clearData12a.php", // "another_php_file.php",
                        data: 'theOption=' + sel,
...
<div>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <form action="importData12a.php" method="post" enctype="multipart/form-data" id="importFrm">
...
<th>ATV</th>
                ...
                <?php
                    ...
                    $query =mysql_query("SELECT * FROM c12a_pkChrt");
			...
			<td><?php echo $row['agv']; ?></td>
			<td><?php echo $row['atv']; ?></td>
