...
<?php
	...
	<form action="saveTime11c.php" method="post" enctype="multipart/form-data">
	<?php 

		$sql =	mysql_query("select * from c11c_timetbl where sl=1");
	...
	*English,Financial Markets,Entrepreneurship,Business Studies,Mils,Environmental Education,Fundamentals of Business Mathematics,Accountancy,Economics,Mutual Funds,Computer Science, Informatics Practices, Information Technology, Travel & Tourism<BR>
	*EXAM dates should be entered in ascending order</p>
	</div></div>
	<div class="panel-body">
	<div style="font-size: 30px;font-weight: bold;font-style: italic;color: blue">CLASS-XI(Commerce)</div>
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=2");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=3");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=4");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=5");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=6");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=7");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=8");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=9");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=10");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=11");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=12");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=13");
		$row = mysql_fetch_array($sql);
	...
	<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=14");
		$row = mysql_fetch_array($sql);
...
<?php 
		...
		$sql =	mysql_query("select * from c11c_timetbl where sl=15");
		$row = mysql_fetch_array($sql);
