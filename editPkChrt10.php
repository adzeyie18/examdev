...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "another_php_file10.php", // "another_php_file.php",
                        data: 'theOption=' + sel,
...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "another_php_fetch10.php", // "another_php_file.php",
                        data: {
                            'dist' : sel,
                            'scho' : sel1,
...
require("dbconn.php");
$query = mysql_query("select distinct district from c10_pkChrt_16 ");

?>
<form action="updatePckChrt10.php" method="POST" enctype="multipart/form-data">
<div class="container">
