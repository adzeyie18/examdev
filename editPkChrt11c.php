...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "centreChange11c.php", // "another_php_file.php",
                        data: 'theOption=' + sel,
...
//alert('You picked: ' + sel);
                    $.ajax({
                        type: "POST",
                        url: "another_php_file11c.php", // "another_php_file.php",
                        data: {
                            'dist' : sel,
                            'scho' : sel1,
...
require("dbconn.php");
$query = mysql_query("select distinct district from c11c_pkChrt ");

?>
<form action="updatePckChrt11c.php" method="POST" enctype="multipart/form-data">
<div class="container">
